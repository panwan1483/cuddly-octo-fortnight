    ...
    <div class="setcont">
      <ul class="set1">
        ...
        <li><span class="webname">
          <input name="paramCode" type="text" id="paramCode" value="${systemConfig.paramCode}" size="40" readonly="readonly"/>
          </span></li>
      </ul>
      <ul class="set1">
        <li><strong class="orange fontsize20">*</strong>参数名称</li>
        <li><span class="webname">
         	  <input name="paramName" type="text" id="paramName" value="${systemConfig.paramName}" size="40" />
            </span>
        </li>
      </ul>
      <ul class="set1">
        ...
        <li><span class="webname">
         	 <input name="paramValue" type="text" id="paramValue" value="${systemConfig.paramValue}" size="40" />
            </span>
        </li>
      </ul>
      <ul class="set1">
        ...
        <li><span class="webname">
            	 <input name="paramDesc" type="text" id="paramDesc" value="${systemConfig.paramDesc}" size="100" />
            </span>
        </li>
      </ul>
    </div>
