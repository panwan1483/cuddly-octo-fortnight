...
<body>
<div class="cont">
  <h1 class="seth1">修改分类</h1>
  <form name="theForm" id="theForm" action="<%=request.getContextPath()%>/admin/goods/goodsClassUpdate?id=${goodsClass.id}" method="post">
    <div class="specification" style="padding-top:0px;">
      <ul class="spec_sports">
        <li><strong class="orange fontsize20">*</strong>分类名称
	        <span class="span1">
	          	<input name="className" type="text" id="className" value="${goodsClass.className}" size="40" />
	        </span>
          </li>
      </ul>
     <ul class="spec_sports">
        ...
        <span class="span1">
           	 <input name="display" type="radio" id="display" value="1" checked="true"/>显示
      ...
      <ul class="spec_sports">
        ...
        <span class="span1">
         	  <input type="text" value="${goodsClass.level }" readonly="readonly"/>
            </span>
        </li>
      </ul>
      <ul class="spec_sports">
        ...
        <span class="span1">
           	 <input name="recommend" type="radio" id="recommend" value="1" checked="true"/>推荐
      ...
      <ul class="spec_sports">
        ...
        <span class="span1">
             <input name="sequence" type="text" id="sequence" size="40" value="${goodsClass.sequence }"/>
         </span>
        </li>
      </ul>
      <ul class="spec_sports">
        ...
        <span class="span1">
             <textarea id="seoDescription" name="seoDescription" value="" rows="5" cols="50">${goodsClass.seoDescription}</textarea>
         </span>
        </li>
      </ul>
       <ul class="spec_sports">
        ...
        <span class="span1">
             <input name="seoKeywords" type="text" id="seoKeywords" value="${goodsClass.seoKeywords }" size="40" />
         </span>
        </li>
      </ul>
    </div>
 ...
 <script type="text/javascript">
  $(function(){
  	$("input[value="+ ${goodsClass.display} +"][name=display]" ).attr("checked",true);
  	$("input[value="+ ${goodsClass.recommend} +"][name=recommend]").attr("checked",true);
  });
  </script>
