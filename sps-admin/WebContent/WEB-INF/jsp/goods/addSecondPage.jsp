...
<body>
<div class="cont">
  <h1 class="seth1">添加二级分类</h1>
  <form name="theForm" id="theForm" action="<%=request.getContextPath()%>/admin/goods/secondGoodsClassSave" method="post">
    <div class="specification" style="padding-top:0px;overflow-y:scroll">
     ...
     <ul class="spec_sports">
      ...
      <ul class="spec_sports">
       ...
       <ul class="spec_sports">
        <li><strong class="orange fontsize20">*</strong>所属父类编号
        <span class="span1">
            <input type="text" id="parentId" name="parentId" value="${id }" readonly="readonly"/>
            </span>
        </li>
        <li><strong class="orange fontsize20">*</strong>所属父类名称
        <span class="span1">
            <input type="text" value="${goodsClass.className }" readonly="readonly"/>
            </span>
        </li>
      </ul>
      <ul class="spec_sports">
...
$("#theForm").validate({
	...
	messages:{
		...
		goodsTypeId:{required:"商品类型编号不能为空"},
